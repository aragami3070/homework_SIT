...
int main() {
	...
	cout << "Задание 1 быстрая сортировка (по зарплате): 1" << endl;
	cout << "Задание 2 гномья сортировка (сначала по должности, потом по зарплате): 2" << endl;
	cout << "Задание 3 сортировка вставками (сначала по фамилии, потом по стажу работы, потом по году рождения): 3" << endl;
